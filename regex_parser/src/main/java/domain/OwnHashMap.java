 ...
 * 
 * <p>Largely based on the HashTable with a few additions exclusive to maps.
 * </p>
 * 
...
public class OwnHashMap<K,V> extends HashTable<K,V>{
     ...
     * 
     * <p>
     * Calculates in which cell of the array the key would be stored. 
     * If there is no list there, returns null. Otherwise searches the list
     * for the right PairNode and returns its value.
     * </p>
     * 
     * @param key
     * @return 
